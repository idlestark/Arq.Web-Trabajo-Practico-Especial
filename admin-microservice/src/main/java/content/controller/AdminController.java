...
public class AdminController {
    ...
    @Operation(summary = "Get scooters with most trips", description = "Gets a list of the scooters with most trips in a year")
    ...
    @Operation(summary = "Get scooters status", description = "Gets a count of all operative and under maintenance scooters")
    @ApiResponse(responseCode = "200", description = "Scooters status obtained successfully")
